...
begin
  ...
  begin
    ...
    Rewrite(FName, 1);
    ProgressBar1.Max := FinalAdres - BeginAdres;
...
begin
  ...
  begin
    ...
    repeat
      ...
      //Очистка памяти
      ProgressBar1.Max := SizFile - BuferAdres;
      ProgressBar1.Min := BuferAdres;
      ProgressBar1.Position := FilePos(FName);
      BegLength := SizFile - BuferAdres - ProgressBar1.Position;
